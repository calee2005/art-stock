...
当前进度：P0 已完成；P1 **F-010**–**F-015** 已完成；P2 **F-020**–**F-023** 已完成；P3 **F-030**–**F-033** 已完成；P4 **F-040**–**F-046** 已完成；P5 **F-050**–**F-052** 已完成；P6 **F-060**–**F-064** 已完成；P7 **F-070**–**F-071** 已完成；P8 **F-080**–**F-081** 已完成，**F-082** 待领取；P9 **F-090**–**F-092** 已完成。完成一项后请同步改 JSON 的 `status`，并把下面相应行改为 `[x]`。
...
- [x] **F-015** 元数据/缩略图缓存与同步队列 — [05-sync](03-features/05-sync.md)（F-012）
...
- [x] **F-022** 沙箱 SQLite 与 pinned/缓存分离（F-021, F-015）
- [x] **F-023** Pad 真机：OSS 浏览与上传（F-020, F-022, F-010）
...
- [x] **F-045** Pad 收件箱扫描（F-033, F-040）
- [x] **F-046** Pad 仅 Wi-Fi 下载原文件（F-023, F-044）

## P5 创作工具

- [x] **F-050** Markdown WYSIWYG / TOC / 素材 — [06-markdown](03-features/06-markdown.md)
- [x] **F-051** PDF 翻页 — [07-pdf](03-features/07-pdf.md)
- [x] **F-052** 思维导图 JSON — [08-mindmap](03-features/08-mindmap.md)
...
- [x] **F-063** 多维数据表 — [09-database](03-features/09-database.md)
- [x] **F-064** 冲突 UI — [11-conflicts](03-features/11-conflicts.md)（F-043）

## P7 扩展

- [x] **F-070** 桌面插件宿主 — [12-plugins](03-features/12-plugins.md)
- [x] **F-071** MCP stdio — [13-mcp](03-features/13-mcp.md)（F-050, F-061）

## P8 墨水屏

- [x] **F-080** subtree 拉取上游并刷机验证启动 — [17-eink](03-features/17-eink.md)（COM3；IDF `C:\esp\v6.0.3\esp-idf`；RawDraw 400x300 + WiFi 配网页）
...
- [x] **F-090** 多远端复制（排序加锁）
- [x] **F-091** GitHub Pages 与 CORS
- [x] **F-092** Android SAF 与后台尽力同步
