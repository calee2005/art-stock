...
当前进度：P0 已完成；P1 **F-010**–**F-015** 已完成；P2 **F-020**–**F-023** 已完成；P3 **F-030**–**F-034** 已完成；P4 **F-040**–**F-046** 已完成；P5 **F-050**–**F-052** 已完成；P6 **F-060**–**F-064** 已完成；P7 **F-070**–**F-071** 已完成；P8 **F-080**–**F-081** 已完成，**F-082** 待领取；P9 **F-090**–**F-092** 已完成。完成一项后请同步改 JSON 的 `status`，并把下面相应行改为 `[x]`。
...
- [x] **F-080** subtree 拉取上游并刷机验证启动 — [17-eink](03-features/17-eink.md)
