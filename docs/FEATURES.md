...
当前进度：P0 已完成；P1 **F-010**–**F-015** 已完成；P3 **F-030**–**F-032** 已完成；P4 **F-040**–**F-044** 已完成；P5 **F-050**–**F-052** 已完成；P6 **F-060**–**F-064** 已完成；P7 **F-070**–**F-071** 已完成。完成一项后请同步改 JSON 的 `status`，并把下面相应行改为 `[x]`。
