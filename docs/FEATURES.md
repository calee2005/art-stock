...
当前进度：P0 已完成；P1 **F-010**–**F-015** 已完成；P2 **F-020**–**F-023** 已完成；P3 **F-030**–**F-033** 已完成；P4 **F-040**–**F-046** 已完成；P5 **F-050**–**F-052** 已完成；P6 **F-060**–**F-064** 已完成；P7 **F-070**–**F-071** 已完成；P8 **F-081** 已完成（**F-080**、**F-082** blocked：无墨水屏）；P9 **F-090**–**F-092** 已完成。软件功能已完成，剩余仅硬件 blocked。完成一项后请同步改 JSON 的 `status`，并把下面相应行改为 `[x]`。
