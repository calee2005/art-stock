...
当前进度：P0 **F-000**、**F-001**、**F-002** 已完成。完成一项后请同步改 JSON 的 `status`，并把下面相应行改为 `[x]`。
...
- [ ] **F-005** Tauri 空壳 desktop + Android 目标 — [15-desktop](03-features/15-desktop.md)（F-000）

## P1 资料库 MVP

- [ ] **F-010** 资料库 CRUD 与 manifest — [02-libraries](03-features/02-libraries.md)（F-004）
- [ ] **F-011** 多层文件夹树（F-010）
- [ ] **F-012** 文件导入与 object meta（F-011）
