...
#[tauri::command]
pub fn pad_wifi_e2e_config(app: tauri::AppHandle) -> Result<Option<Value>, String> {
    read_e2e_json(&app, "pad-wifi-e2e.json")
}

#[tauri::command]
pub fn pad_wifi_e2e_report(app: tauri::AppHandle, status: Value) -> Result<(), String> {
    write_e2e_json(&app, "pad-wifi-e2e-status.json", status)
}

#[tauri::command]
pub fn pad_scan_e2e_config(app: tauri::AppHandle) -> Result<Option<Value>, String> {
    read_e2e_json(&app, "pad-scan-e2e.json")
}

#[tauri::command]
pub fn pad_scan_e2e_report(app: tauri::AppHandle, status: Value) -> Result<(), String> {
